...
Current release: **2.8.0** (unlocked package, `04tKb000000Eh18IAC`)

Install via URL:
- Production / Developer Edition: https://login.salesforce.com/packaging/installPackage.apexp?p0=04tKb000000Eh18IAC
- Sandbox: https://test.salesforce.com/packaging/installPackage.apexp?p0=04tKb000000Eh18IAC

Or with the Salesforce CLI:

```
sf package install --package 04tKb000000Eh18IAC --target-org <org-alias> --wait 10
```
